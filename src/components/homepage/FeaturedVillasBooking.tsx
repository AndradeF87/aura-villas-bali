    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          ...
          <button className="px-8 py-4 bg-deep-green text-white rounded-full font-medium hover:bg-deep-green/90 transition-colors duration-300">
            Explore All Villas
          </button>
        </div>
      </div>
