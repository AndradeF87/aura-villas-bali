...
const experiences = [
  {
    ...
    price: 'From Rp 1.000.000/person',
    duration: '2-3 hours',
  ...
  },
  {
    ...
    price: 'From Rp 1.250.000/treatment',
    duration: '60-90 mins',
  ...
  },
  {
    ...
    price: 'From Rp 3.950.000/session',
    duration: '2 hours',
          ...
          {experiences.map((experience) => {
            ...
            return (
              <div
                ...
                className="group bg-warm-ivory rounded-xl p-6 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer"
              >
                {/* Header */}
